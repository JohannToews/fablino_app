...
const SiblingInputModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent 
        ref={contentRef}
        className="w-[85vw] max-w-[420px] rounded-2xl sm:top-[50%] sm:translate-y-[-50%] max-sm:top-[10%] max-sm:translate-y-0 landscape:top-[5%] landscape:translate-y-0 landscape:max-h-[85vh] landscape:overflow-y-auto"
      >
        <DialogHeader>
