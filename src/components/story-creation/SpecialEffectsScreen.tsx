...
const settingsTranslations: Record<string, Record<string, string>> = {
  de: { lengthLabel: 'Länge', short: 'Kurz', medium: 'Mittel', long: 'Lang', extra_long: 'Extra-Lang', difficultyLabel: 'Niveau', easy: 'Erstleser', medium: 'Flüssig', hard: 'Sicher', seriesLabel: 'Kapitel-Abenteuer', seriesNo: 'Nein', seriesYes: 'Ja', languageLabel: 'Sprache', seriesModeNormal: 'Normales Kapitel-Abenteuer', seriesModeNormalDesc: 'Die Geschichte fließt von Episode zu Episode', seriesModeInteractive: 'Du entscheidest!', seriesModeInteractiveDesc: 'Dein Kind entscheidet am Ende jeder Episode wie es weitergeht' },
  fr: { lengthLabel: 'Longueur', short: 'Court', medium: 'Moyen', long: 'Long', extra_long: 'Très long', difficultyLabel: 'Niveau', easy: 'Débutant', medium: 'Courant', hard: 'Confirmé', seriesLabel: 'Aventure à chapitres', seriesNo: 'Non', seriesYes: 'Oui', languageLabel: 'Langue', seriesModeNormal: 'Aventure à chapitres normale', seriesModeNormalDesc: "L'histoire suit son cours d'épisode en épisode", seriesModeInteractive: "C'est toi qui décides !", seriesModeInteractiveDesc: "Ton enfant décide comment l'histoire continue" },
  en: { lengthLabel: 'Length', short: 'Short', medium: 'Medium', long: 'Long', extra_long: 'Extra Long', difficultyLabel: 'Level', easy: 'Beginner', medium: 'Fluent', hard: 'Confident', seriesLabel: 'Chapter Adventure', seriesNo: 'No', seriesYes: 'Yes', languageLabel: 'Language', seriesModeNormal: 'Normal Chapter Adventure', seriesModeNormalDesc: 'The story flows from episode to episode', seriesModeInteractive: 'You decide!', seriesModeInteractiveDesc: 'Your child decides how the story continues' },
  es: { lengthLabel: 'Longitud', short: 'Corto', medium: 'Medio', long: 'Largo', extra_long: 'Extra largo', difficultyLabel: 'Nivel', easy: 'Principiante', medium: 'Fluido', hard: 'Seguro', seriesLabel: 'Aventura por capítulos', seriesNo: 'No', seriesYes: 'Sí', languageLabel: 'Idioma', seriesModeNormal: 'Aventura por capítulos normal', seriesModeNormalDesc: 'La historia fluye de episodio en episodio', seriesModeInteractive: '¡Tú decides!', seriesModeInteractiveDesc: 'Tu hijo decide cómo continúa la historia' },
  nl: { lengthLabel: 'Lengte', short: 'Kort', medium: 'Gemiddeld', long: 'Lang', extra_long: 'Extra lang', difficultyLabel: 'Niveau', easy: 'Beginner', medium: 'Vloeiend', hard: 'Zeker', seriesLabel: 'Hoofdstuk-avontuur', seriesNo: 'Nee', seriesYes: 'Ja', languageLabel: 'Taal', seriesModeNormal: 'Normaal hoofdstuk-avontuur', seriesModeNormalDesc: 'Het verhaal vloeit van aflevering naar aflevering', seriesModeInteractive: 'Jij beslist!', seriesModeInteractiveDesc: 'Je kind beslist hoe het verder gaat' },
  it: { lengthLabel: 'Lunghezza', short: 'Breve', medium: 'Medio', long: 'Lungo', extra_long: 'Extra lungo', difficultyLabel: 'Livello', easy: 'Principiante', medium: 'Fluente', hard: 'Sicuro', seriesLabel: 'Avventura a capitoli', seriesNo: 'No', seriesYes: 'Sì', languageLabel: 'Lingua', seriesModeNormal: 'Avventura a capitoli normale', seriesModeNormalDesc: 'La storia scorre da episodio a episodio', seriesModeInteractive: 'Decidi tu!', seriesModeInteractiveDesc: 'Il tuo bambino decide come continua la storia' },
  bs: { lengthLabel: 'Dužina', short: 'Kratko', medium: 'Srednje', long: 'Dugo', extra_long: 'Ekstra dugo', difficultyLabel: 'Nivo', easy: 'Početnik', medium: 'Tečno', hard: 'Sigurno', seriesLabel: 'Avantura s poglavljima', seriesNo: 'Ne', seriesYes: 'Da', languageLabel: 'Jezik', seriesModeNormal: 'Normalna avantura s poglavljima', seriesModeNormalDesc: 'Priča teče od epizode do epizode', seriesModeInteractive: 'Ti odlučuješ!', seriesModeInteractiveDesc: 'Tvoje dijete odlučuje kako priča nastavlja' },
  tr: { lengthLabel: 'Uzunluk', short: 'Kısa', medium: 'Orta', long: 'Uzun', extra_long: 'Çok uzun', difficultyLabel: 'Seviye', easy: 'Başlangıç', medium: 'Akıcı', hard: 'Güvenli', seriesLabel: 'Bölüm Macerası', seriesNo: 'Hayır', seriesYes: 'Evet', languageLabel: 'Dil', seriesModeNormal: 'Normal bölüm macerası', seriesModeNormalDesc: 'Hikaye bölümden bölüme akar', seriesModeInteractive: 'Sen karar ver!', seriesModeInteractiveDesc: 'Çocuğunuz hikayenin nasıl devam edeceğine karar verir' },
  bg: { lengthLabel: 'Дължина', short: 'Кратко', medium: 'Средно', long: 'Дълго', extra_long: 'Много дълго', difficultyLabel: 'Ниво', easy: 'Начинаещ', medium: 'Свободно', hard: 'Уверено', seriesLabel: 'Приключение с глави', seriesNo: 'Не', seriesYes: 'Да', languageLabel: 'Език', seriesModeNormal: 'Нормално приключение с глави', seriesModeNormalDesc: 'Историята тече от епизод на епизод', seriesModeInteractive: 'Ти решаваш!', seriesModeInteractiveDesc: 'Детето решава как продължава историята' },
  ro: { lengthLabel: 'Lungime', short: 'Scurt', medium: 'Mediu', long: 'Lung', extra_long: 'Extra lung', difficultyLabel: 'Nivel', easy: 'Începător', medium: 'Fluent', hard: 'Sigur', seriesLabel: 'Aventură pe capitole', seriesNo: 'Nu', seriesYes: 'Da', languageLabel: 'Limbă', seriesModeNormal: 'Aventură pe capitole normală', seriesModeNormalDesc: 'Povestea curge din episod în episod', seriesModeInteractive: 'Tu decizi!', seriesModeInteractiveDesc: 'Copilul decide cum continuă povestea' },
  pl: { lengthLabel: 'Długość', short: 'Krótka', medium: 'Średnia', long: 'Długa', extra_long: 'Bardzo długa', difficultyLabel: 'Poziom', easy: 'Początkujący', medium: 'Płynnie', hard: 'Pewnie', seriesLabel: 'Przygoda z rozdziałami', seriesNo: 'Nie', seriesYes: 'Tak', languageLabel: 'Język', seriesModeNormal: 'Normalna przygoda z rozdziałami', seriesModeNormalDesc: 'Historia płynie od odcinka do odcinka', seriesModeInteractive: 'Ty decydujesz!', seriesModeInteractiveDesc: 'Dziecko decyduje jak historia się potoczy' },
  lt: { lengthLabel: 'Ilgis', short: 'Trumpa', medium: 'Vidutinė', long: 'Ilga', extra_long: 'Labai ilga', difficultyLabel: 'Lygis', easy: 'Pradedantysis', medium: 'Sklandžiai', hard: 'Užtikrintai', seriesLabel: 'Nuotykis su skyriais', seriesNo: 'Ne', seriesYes: 'Taip', languageLabel: 'Kalba', seriesModeNormal: 'Normalus nuotykis su skyriais', seriesModeNormalDesc: 'Istorija teka nuo epizodo prie epizodo', seriesModeInteractive: 'Tu sprendi!', seriesModeInteractiveDesc: 'Vaikas sprendžia kaip istorija tęsis' },
  hu: { lengthLabel: 'Hossz', short: 'Rövid', medium: 'Közepes', long: 'Hosszú', extra_long: 'Extra hosszú', difficultyLabel: 'Szint', easy: 'Kezdő', medium: 'Folyékony', hard: 'Biztos', seriesLabel: 'Fejezet-kaland', seriesNo: 'Nem', seriesYes: 'Igen', languageLabel: 'Nyelv', seriesModeNormal: 'Normál fejezet-kaland', seriesModeNormalDesc: 'A történet epizódról epizódra halad', seriesModeInteractive: 'Te döntesz!', seriesModeInteractiveDesc: 'A gyermeked eldönti hogyan folytatódik a történet' },
  ca: { lengthLabel: 'Llargada', short: 'Curta', medium: 'Mitjana', long: 'Llarga', extra_long: 'Extra llarga', difficultyLabel: 'Nivell', easy: 'Principiant', medium: 'Fluid', hard: 'Segur', seriesLabel: 'Aventura per capítols', seriesNo: 'No', seriesYes: 'Sí', languageLabel: 'Idioma', seriesModeNormal: 'Aventura per capítols normal', seriesModeNormalDesc: "La història flueix d'episodi en episodi", seriesModeInteractive: 'Tu decideixes!', seriesModeInteractiveDesc: 'El teu fill decideix com continua la història' },
  sl: { lengthLabel: 'Dolžina', short: 'Kratka', medium: 'Srednja', long: 'Dolga', extra_long: 'Zelo dolga', difficultyLabel: 'Raven', easy: 'Začetnik', medium: 'Tekoče', hard: 'Zanesljivo', seriesLabel: 'Pustolovščina po poglavjih', seriesNo: 'Ne', seriesYes: 'Da', languageLabel: 'Jezik', seriesModeNormal: 'Normalna pustolovščina po poglavjih', seriesModeNormalDesc: 'Zgodba teče od epizode do epizode', seriesModeInteractive: 'Ti odločaš!', seriesModeInteractiveDesc: 'Otrok odloči kako se zgodba nadaljuje' },
  uk: { lengthLabel: 'Довжина', short: 'Коротка', medium: 'Середня', long: 'Довга', extra_long: 'Дуже довга', difficultyLabel: 'Рівень', easy: 'Початківець', medium: 'Вільно', hard: 'Впевнено', seriesLabel: 'Пригода з розділами', seriesNo: 'Ні', seriesYes: 'Так', languageLabel: 'Мова', seriesModeNormal: 'Звичайна пригода з розділами', seriesModeNormalDesc: 'Історія йде від епізоду до епізоду', seriesModeInteractive: 'Ти вирішуєш!', seriesModeInteractiveDesc: 'Дитина вирішує, як продовжиться історія' },
  ru: { lengthLabel: 'Длина', short: 'Короткая', medium: 'Средняя', long: 'Длинная', extra_long: 'Очень длинная', difficultyLabel: 'Уровень', easy: 'Начинающий', medium: 'Свободно', hard: 'Уверенно', seriesLabel: 'Приключение по главам', seriesNo: 'Нет', seriesYes: 'Да', languageLabel: 'Язык', seriesModeNormal: 'Обычное приключение по главам', seriesModeNormalDesc: 'История течёт от эпизода к эпизоду', seriesModeInteractive: 'Ты решаешь!', seriesModeInteractiveDesc: 'Ребёнок решает, как продолжится история' },
  pt: { lengthLabel: 'Comprimento', short: 'Curto', medium: 'Médio', long: 'Longo', extra_long: 'Extra longo', difficultyLabel: 'Nível', easy: 'Iniciante', medium: 'Fluente', hard: 'Seguro', seriesLabel: 'Aventura por capítulos', seriesNo: 'Não', seriesYes: 'Sim', languageLabel: 'Língua', seriesModeNormal: 'Aventura por capítulos normal', seriesModeNormalDesc: 'A história flui de episódio em episódio', seriesModeInteractive: 'Tu decides!', seriesModeInteractiveDesc: 'O teu filho decide como a história continua' },
  sk: { lengthLabel: 'Dĺžka', short: 'Krátky', medium: 'Stredný', long: 'Dlhý', extra_long: 'Veľmi dlhý', difficultyLabel: 'Úroveň', easy: 'Začiatočník', medium: 'Plynulo', hard: 'Isto', seriesLabel: 'Dobrodružstvo s kapitolami', seriesNo: 'Nie', seriesYes: 'Áno', languageLabel: 'Jazyk', seriesModeNormal: 'Normálne dobrodružstvo s kapitolami', seriesModeNormalDesc: 'Príbeh plynie od epizódy k epizóde', seriesModeInteractive: 'Ty rozhoduješ!', seriesModeInteractiveDesc: 'Dieťa rozhodne, ako príbeh pokračuje' },
};
