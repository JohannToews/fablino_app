...
<<<<<<< HEAD
      ...
      bs: "Priča se piše...", tr: "Hikâye yazılıyor...", bg: "Историята се пише...",
      ro: "Povestea se scrie...", pl: "Historia się pisze...", lt: "Rašoma istorija...",
...
<<<<<<< HEAD
      ...
      bs: "Provjera kvaliteta...", tr: "Kalite kontrolü...", bg: "Проверка на качеството...",
      ro: "Verificare calitate...", pl: "Kontrola jakości...", lt: "Kokybės patikra...",
...
de: "Bilder werden gemalt...", fr: "Les images sont en cours de création...",
      ...
      ro: "Imaginile se creează...", pl: "Obrazy się tworzą...", lt: "Kuriami paveikslėliai...",
      hu: "Képek készülnek...", ca: "Les imatges es creen...", sl: "Slike se risujejo...",
      pt: "As imagens estão a ser criadas...", sk: "Obrázky sa vytvárajú...",
      uk: "Малюнки створюються...", ru: "Картинки рисуются...",
    },
    duration: 12000,
  },
  {
...
de: "Fast fertig...", fr: "Presque terminé...",
      ...
      ro: "Aproape gata...", pl: "Prawie gotowe...", lt: "Beveik baigta...",
      hu: "Majdnem kész...", ca: "Gairebé llest...", sl: "Skoraj končano...",
      pt: "Quase pronto...", sk: "Takmer hotové...",
      uk: "Майже готово...", ru: "Почти готово...",
    },
    duration: 60000,
  },
];
