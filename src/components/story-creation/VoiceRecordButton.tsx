...
const VOICE_LABELS: Record<string, {
  ...
  pt: {
    speak: 'Diz o teu desejo!',
    listening: 'O Fablino está a ouvir...',
    retry: 'Tentar outra vez',
    confirm: 'Aceitar',
    mic_denied: 'O Fablino precisa do teu microfone! Pede ajuda aos teus pais.',
    empty: 'Hmm, o Fablino não percebeu. Tenta outra vez!',
    failed: 'Algo correu mal. Tenta outra vez!',
    modalHeader: 'Isto é o que percebi:',
  },
  tr: {
    speak: 'Dileğini söyle!',
    listening: 'Fablino dinliyor...',
    retry: 'Tekrar dene',
    confirm: 'Kabul',
    mic_denied: 'Fablino mikrofonuna ihtiyaç duyuyor! Ebeveynlerinden yardım iste.',
    empty: 'Hmm, Fablino anlamadı. Tekrar dene!',
    failed: 'Bir şeyler yanlış gitti. Tekrar dene!',
    modalHeader: 'Bunu anladım:',
  },
  pl: {
    speak: 'Powiedz swoje życzenie!',
    listening: 'Fablino słucha...',
    retry: 'Spróbuj ponownie',
    confirm: 'Akceptuj',
    mic_denied: 'Fablino potrzebuje mikrofonu! Poproś rodziców o pomoc.',
    empty: 'Hmm, Fablino nie zrozumiał. Spróbuj ponownie!',
    failed: 'Coś poszło nie tak. Spróbuj ponownie!',
    modalHeader: 'Oto co zrozumiałem:',
  },
  sk: {
    speak: 'Povedz svoje prianie!',
    listening: 'Fablino počúva...',
    retry: 'Skús znova',
    confirm: 'Prijať',
    mic_denied: 'Fablino potrebuje tvoj mikrofón! Požiadaj rodičov o pomoc.',
    empty: 'Hmm, Fablino ti nerozumel. Skús znova!',
    failed: 'Niečo sa pokazilo. Skús znova!',
    modalHeader: 'Tu je, čo som pochopil:',
  },
  bg: {
    speak: 'Кажи желанието си!',
    listening: 'Фабліно слуша...',
    retry: 'Опитай отново',
    confirm: 'Приемам',
    mic_denied: 'Фабліно се нуждае от микрофона ти! Помоли родителите си за помощ.',
    empty: 'Хм, Фабліно не те разбра. Опитай отново!',
    failed: 'Нещо се обърка. Опитай отново!',
    modalHeader: 'Ето какво разбрах:',
  },
  ro: {
    speak: 'Spune-ți dorința!',
    listening: 'Fablino ascultă...',
    retry: 'Încearcă din nou',
    confirm: 'Accept',
    mic_denied: 'Fablino are nevoie de microfonul tău! Cere ajutor părinților.',
    empty: 'Hmm, Fablino nu te-a înțeles. Încearcă din nou!',
    failed: 'Ceva n-a mers bine. Încearcă din nou!',
    modalHeader: 'Iată ce am înțeles:',
  },
  lt: {
    speak: 'Pasakyk savo norą!',
    listening: 'Fablino klauso...',
    retry: 'Bandyk dar kartą',
    confirm: 'Priimti',
    mic_denied: 'Fablino reikia tavo mikrofono! Paprašyk tėvų pagalbos.',
    empty: 'Hmm, Fablino nesuprato. Bandyk dar kartą!',
    failed: 'Kažkas nutiko. Bandyk dar kartą!',
    modalHeader: 'Štai ką supratau:',
  },
  hu: {
    speak: 'Mondd el a kívánságodat!',
    listening: 'Fablino hallgat...',
    retry: 'Próbáld újra',
    confirm: 'Elfogadás',
    mic_denied: 'Fablino a mikrofonodra van szüksége! Kérd a szüleid segítségét.',
    empty: 'Hmm, Fablino nem értett meg. Próbáld újra!',
    failed: 'Valami hiba történt. Próbáld újra!',
    modalHeader: 'Ezt értettem meg:',
  },
  ca: {
    speak: 'Digues el teu desig!',
    listening: 'Fablino escolta...',
    retry: 'Torna-ho a provar',
    confirm: 'Acceptar',
    mic_denied: 'Fablino necessita el teu micròfon! Demana ajuda als teus pares.',
    empty: 'Hmm, Fablino no t\'ha entès. Torna-ho a provar!',
    failed: 'Quelcom ha anat malament. Torna-ho a provar!',
    modalHeader: 'Això és el que he entès:',
  },
  sl: {
    speak: 'Povej svojo željo!',
    listening: 'Fablino posluša...',
    retry: 'Poskusi znova',
    confirm: 'Sprejmi',
    mic_denied: 'Fablino potrebuje tvoj mikrofon! Prosi starše za pomoč.',
    empty: 'Hmm, Fablino te ni razumel. Poskusi znova!',
    failed: 'Nekaj je šlo narobe. Poskusi znova!',
    modalHeader: 'To sem razumel:',
  },
};
