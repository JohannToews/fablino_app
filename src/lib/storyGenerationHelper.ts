...
type TerminalStatus = 'verified' | 'complete' | 'images_partial' | 'images_failed' | 'text_complete' | 'images_complete';
const TERMINAL_SUCCESS: string[] = ['verified', 'complete', 'images_partial', 'images_failed', 'text_complete', 'images_complete'];
