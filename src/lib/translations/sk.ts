...
const sk: Translations = {
  ...
  chapterStories: 'Kapitolové dobrodružstvo',
  coCreate: 'Ty rozhoduješ!',
  ...
  onboardingDisplayName: 'Zobrazované meno',
  onboardingDisplayNameHint: 'Vaše meno, ako sa zobrazuje v aplikácii.',
  onboardingDisplayNamePlaceholder: 'napr. Mama, Otec, Lisa…',
  onboardingNext: 'Next →',
  onboardingBack: '← Back',
  ...
  myLook: 'Môj vzhľad',
  myPeople: 'Moji ľudia',
  appearanceTitle: 'Môj vzhľad',
  appearanceSubtitle: 'Takto vyzerám v mojich príbehoch!',
  appearanceMascotMessage: 'Ukáž mi, ako vyzeráš! Takto ťa budem kresliť v príbehoch.',
  appearanceSkin: 'Farba pleti',
  appearanceHairLengthLabel: 'Dĺžka vlasov',
  appearanceHairTypeLabel: 'Typ vlasov',
  appearanceHairStyleLabel: 'Účes',
  appearanceHairColorLabel: 'Farba vlasov',
  appearanceGlassesLabel: 'Okuliare',
  appearanceGlassesYes: 'S okuliarmi',
  appearanceGlassesNo: 'Bez okuliarov',
  appearanceSaved: 'Uložené! ✨',
  appearanceSave: 'Uložiť',
  appearanceSkinLight: 'Svetlá',
  appearanceSkinMediumLight: 'Svetlo-stredná',
  appearanceSkinMedium: 'Stredná',
  appearanceSkinMediumDark: 'Stredne tmavá',
  appearanceSkinDark: 'Tmavá',
  appearanceHairVeryShort: 'Veľmi krátke',
  appearanceHairShort: 'Krátke',
  appearanceHairMedium: 'Stredné',
  appearanceHairLong: 'Dlhé',
  appearanceHairStraight: 'Rovné',
  appearanceHairWavy: 'Vlnité',
  appearanceHairCurly: 'Kučeravé',
  appearanceHairCoily: 'Afro',
  appearanceHairTightCurly: 'Tesné kučery',
  appearanceEyeColorLabel: 'Farba očí',
  appearanceEyeBrown: 'Hnedé',
  appearanceEyeDarkBrown: 'Tmavohnedé',
  appearanceEyeGreen: 'Zelené',
  appearanceEyeBlue: 'Modré',
  appearanceEyeGray: 'Sivé',
  appearanceStyleLoose: 'Rozpustené',
  appearanceStylePonytail: 'Cop',
  appearanceStyleBraids: 'Vrkoče',
  appearanceStylePigtails: 'Copíky',
  appearanceStyleBun: 'Drdol',
  appearanceStyleBangs: 'Ofina',
  appearanceStyleBraid: 'Vrkoč',
  appearanceStyleBob: 'Bob',
  appearanceStyleHalfUp: 'Napoly vyčesané',
  appearanceStyleTwoBraids: 'Dva vrkoče',
  appearanceStyleUpdo: 'Vyčesané',
  appearanceStyleShortAfro: 'Krátke afro',
  appearanceStyleAfro: 'Afro',
  appearanceStyleAfroPuffs: 'Afro puffs',
  appearanceStyleBoyShort: 'Krátke',
  appearanceStyleSidePart: 'Pešinka',
  appearanceStyleUndercut: 'Undercut',
  appearanceStyleBuzzCut: 'Buzz cut',
  appearanceStyleMediumLength: 'Stredné',
  appearanceStyleSurfer: 'Surferský štýl',
  appearanceStyleCurlsLoose: 'Voľné kučery',
  ...
  myPeopleHeaderMessage: 'Navrhni vzhľad svojej rodiny a priateľov!',
  myPeopleEmpty: 'Zatiaľ žiadne osoby!',
  myPeopleEmptyHint: 'Najprv vytvor príbeh, potom tu môžeš definovať vzhľad svojej rodiny a priateľov.',
  myPeopleAddPerson: 'Pridať osobu',
  myPeopleFamily: 'Rodina',
  myPeopleFriends: 'Priatelia',
  myPeopleAppearanceIncomplete: 'Vzhľad ešte nie je vyplnený',
  myPeopleNoAppearance: 'Vzhľad ešte nie je definovaný',
  myPeopleUsedBy: 'Používa:',
  myPeopleEditAppearance: 'Upraviť vzhľad',
  myPeopleDefineAppearance: 'Definovať vzhľad',
  myPeopleNameLabel: 'Meno',
  myPeopleNamePlaceholder: 'napr. Mama, Dedko Hans, Emma...',
  myPeopleRelationLabel: 'Vzťah',
  myPeopleSelectPlaceholder: 'Vybrať...',
  myPeopleGenderLabel: 'Pohlavie',
  myPeopleGenderMale: '♂ Muž',
  myPeopleGenderFemale: '♀ Žena',
  myPeopleGenderNone: '⚪ Neuvedené',
  myPeopleForWhichKids: 'Pre ktoré deti?',
  myPeopleAddAndDefine: 'Pridať a definovať vzhľad →',
  myPeoplePersonAdded: 'Osoba pridaná! ✨',
  myPeopleAddError: 'Chyba pri pridávaní',
  myPeopleEditorHeader: 'Takto vyzerá {name}!',
  myPeopleSaveError: 'Chyba pri ukladaní',
  myPeopleCreateError: 'Chyba pri vytváraní',
  myPeopleRelationMom: 'Mama',
  myPeopleRelationDad: 'Otec',
  myPeopleRelationGrandma: 'Babička',
  myPeopleRelationGrandpa: 'Dedko',
  myPeopleRelationBrother: 'Brat',
  myPeopleRelationSister: 'Sestra',
  myPeopleRelationAunt: 'Teta',
  myPeopleRelationUncle: 'Strýko',
  myPeopleRelationCousinM: 'Bratranec',
  myPeopleRelationCousinF: 'Sesternica',
  myPeopleRelationFriendM: 'Priateľ',
  myPeopleRelationFriendF: 'Priateľka',
  myPeopleRelationOther: 'Iné',
  myPeopleAgeChild: 'Dieťa',
  myPeopleAgeTeen: 'Tínedžer',
  myPeopleAgeAdult: 'Dospelý',
