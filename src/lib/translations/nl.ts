...
const nl: Translations = {
  ...
  emptyStateStories: 'Nog geen verhalen! Maak je eerste verhaal en Fablino vertelt het je. 🦊',
  emptyStateVocabulary: 'Nog geen woorden verzameld! Tik op een woord in een verhaal om het op te slaan.',
  emptyStateQuiz: 'Nog geen woorden om te oefenen! Verzamel eerst woorden in een verhaal.',
  emptyStateResults: 'Je avontuur begint! Lees je eerste verhaal en verzamel sterren. ⭐',
  stars: 'Sterren',
  streak: 'Dagen',
  ...
  chapterStories: 'Hoofdstuk-avontuur',
  coCreate: 'Jij beslist!',
  ...
  onboardingDisplayName: 'Weergavenaam',
  onboardingDisplayNameHint: 'Je naam zoals die in de app wordt weergegeven.',
  onboardingDisplayNamePlaceholder: 'bijv. Mama, Papa, Lisa…',
  ...
  appearanceSkin: 'Huidskleur',
  appearanceHairLengthLabel: 'Haarlengte',
  appearanceHairTypeLabel: 'Haartype',
  appearanceHairStyleLabel: 'Kapsel',
  appearanceHairColorLabel: 'Haarkleur',
  appearanceGlassesLabel: 'Bril',
  ...
  appearanceSkinMediumDark: 'Middel-donker',
  appearanceSkinDark: 'Donker',
  appearanceHairVeryShort: 'Zeer kort',
  appearanceHairShort: 'Kort',
  appearanceHairMedium: 'Middellang',
  appearanceHairLong: 'Lang',
  appearanceHairStraight: 'Steil',
  appearanceHairWavy: 'Golvend',
  appearanceHairCurly: 'Krullend',
  appearanceHairCoily: 'Kroeshaar',
  appearanceHairTightCurly: 'Strakke krullen',
  appearanceEyeColorLabel: 'Oogkleur',
  appearanceEyeBrown: 'Bruin',
  appearanceEyeDarkBrown: 'Donkerbruin',
  appearanceEyeGreen: 'Groen',
  appearanceEyeBlue: 'Blauw',
  appearanceEyeGray: 'Grijs',
  appearanceStyleLoose: 'Los',
  appearanceStylePonytail: 'Paardenstaart',
  appearanceStyleBraids: 'Vlechten',
  appearanceStylePigtails: 'Staartjes',
  appearanceStyleBun: 'Knot',
  appearanceStyleBangs: 'Pony',
  appearanceStyleBraid: 'Vlecht',
  appearanceStyleBob: 'Bob',
  appearanceStyleHalfUp: 'Half opgestoken',
  appearanceStyleTwoBraids: 'Twee vlechten',
  appearanceStyleUpdo: 'Opgestoken',
  appearanceStyleShortAfro: 'Kort afro',
  appearanceStyleAfro: 'Afro',
  appearanceStyleAfroPuffs: 'Afro puffs',
  appearanceStyleBoyShort: 'Kort',
  appearanceStyleSidePart: 'Zijscheiding',
  appearanceStyleUndercut: 'Undercut',
  appearanceStyleBuzzCut: 'Buzz cut',
  appearanceStyleMediumLength: 'Halflang',
  appearanceStyleSurfer: 'Surfer-look',
  appearanceStyleCurlsLoose: 'Losse krullen',
  appearanceStyleTwistOut: 'Twist-out',
  appearanceStyleTapered: 'Getapt',
  ...
  myPeopleHeaderMessage: 'Ontwerp het uiterlijk van je familie en vrienden!',
  myPeopleEmpty: 'Nog geen personen toegevoegd!',
  myPeopleEmptyHint: 'Maak eerst een verhaal, dan kun je hier het uiterlijk van je familie en vrienden bepalen.',
  myPeopleAddPerson: 'Persoon toevoegen',
  myPeopleFamily: 'Familie',
  myPeopleFriends: 'Vrienden',
  myPeopleAppearanceIncomplete: 'Uiterlijk nog niet ingevuld',
  myPeopleNoAppearance: 'Nog geen uiterlijk gedefinieerd',
  myPeopleUsedBy: 'Gebruikt door:',
  myPeopleEditAppearance: 'Uiterlijk bewerken',
  myPeopleDefineAppearance: 'Uiterlijk definiëren',
  myPeopleNameLabel: 'Naam',
  myPeopleNamePlaceholder: 'bijv. Mama, Opa Hans, Emma...',
  myPeopleRelationLabel: 'Relatie',
  myPeopleSelectPlaceholder: 'Kiezen...',
  myPeopleGenderLabel: 'Geslacht',
  myPeopleGenderMale: '♂ Mannelijk',
  myPeopleGenderFemale: '♀ Vrouwelijk',
  myPeopleGenderNone: '⚪ Nvt',
  myPeopleForWhichKids: 'Voor welke kinderen?',
  myPeopleAddAndDefine: 'Toevoegen & uiterlijk definiëren →',
  myPeoplePersonAdded: 'Persoon toegevoegd! ✨',
  myPeopleAddError: 'Fout bij toevoegen',
  myPeopleEditorHeader: 'Zo ziet {name} eruit!',
  myPeopleSaveError: 'Fout bij opslaan',
  myPeopleCreateError: 'Fout bij aanmaken',
  myPeopleRelationMom: 'Mama',
  myPeopleRelationDad: 'Papa',
  myPeopleRelationGrandma: 'Oma',
  myPeopleRelationGrandpa: 'Opa',
  myPeopleRelationBrother: 'Broer',
  myPeopleRelationSister: 'Zus',
  myPeopleRelationAunt: 'Tante',
  myPeopleRelationUncle: 'Oom',
  myPeopleRelationCousinM: 'Neef',
  myPeopleRelationCousinF: 'Nicht',
  myPeopleRelationFriendM: 'Vriend',
  myPeopleRelationFriendF: 'Vriendin',
  myPeopleRelationOther: 'Overig',
  myPeopleAgeChild: 'Kind',
  myPeopleAgeTeen: 'Tiener',
  myPeopleAgeAdult: 'Volwassene',
