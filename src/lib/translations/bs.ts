...
const bs: Translations = {
  ...
  myPeopleHeaderMessage: 'Oblikuj izgled svoje porodice i prijatelja!',
  myPeopleEmpty: 'Još nema dodanih osoba!',
  myPeopleEmptyHint: 'Prvo kreiraj priču, pa onda ovdje možeš definirati izgled svoje porodice i prijatelja.',
  myPeopleAddPerson: 'Dodaj osobu',
  myPeopleFamily: 'Porodica',
  myPeopleFriends: 'Prijatelji',
  myPeopleAppearanceIncomplete: 'Izgled još nije popunjen',
  myPeopleNoAppearance: 'Još nije definiran izgled',
  myPeopleUsedBy: 'Koristi:',
  myPeopleEditAppearance: 'Uredi izgled',
  myPeopleDefineAppearance: 'Definiraj izgled',
  myPeopleNameLabel: 'Ime',
  myPeopleNamePlaceholder: 'npr. Mama, Dedo Hans, Emma...',
  myPeopleRelationLabel: 'Odnos',
  myPeopleSelectPlaceholder: 'Odaberi...',
  myPeopleGenderLabel: 'Spol',
  myPeopleGenderMale: '♂ Muško',
  myPeopleGenderFemale: '♀ Žensko',
  myPeopleGenderNone: '⚪ N/P',
  myPeopleForWhichKids: 'Za koju djecu?',
  myPeopleAddAndDefine: 'Dodaj i definiraj izgled →',
  myPeoplePersonAdded: 'Osoba dodana! ✨',
  myPeopleAddError: 'Greška pri dodavanju',
  myPeopleEditorHeader: 'Ovako izgleda {name}!',
  myPeopleSaveError: 'Greška pri spremanju',
  myPeopleCreateError: 'Greška pri kreiranju',
  myPeopleRelationMom: 'Mama',
  myPeopleRelationDad: 'Tata',
  myPeopleRelationGrandma: 'Baka',
  myPeopleRelationGrandpa: 'Dedo',
  myPeopleRelationBrother: 'Brat',
  myPeopleRelationSister: 'Sestra',
  myPeopleRelationAunt: 'Tetka',
  myPeopleRelationUncle: 'Ujak',
  myPeopleRelationCousinM: 'Rođak',
  myPeopleRelationCousinF: 'Rođaka',
  myPeopleRelationFriendM: 'Prijatelj',
  myPeopleRelationFriendF: 'Prijateljica',
  myPeopleRelationOther: 'Ostalo',
  myPeopleAgeChild: 'Dijete',
  myPeopleAgeTeen: 'Tinejdžer',
  myPeopleAgeAdult: 'Odrasli',
