...
const en: Translations = {
  ...
  emptyStateStories: 'No stories yet! Create your first story and Fablino will tell it to you. 🦊',
  emptyStateVocabulary: 'No words collected yet! Tap a word in a story to save it.',
  emptyStateQuiz: 'No words to practice yet! Collect words in a story first.',
  emptyStateResults: 'Your adventure begins! Read your first story and collect stars. ⭐',
  stars: 'Stars',
  streak: 'Days',
  ...
  chapterStories: 'Chapter Adventure',
  coCreate: 'You decide!',
  ...
  onboardingDisplayName: 'Display Name',
  onboardingDisplayNameHint: 'Your name as it appears in the app.',
  onboardingDisplayNamePlaceholder: 'e.g. Mom, Dad, Lisa…',
  onboardingNext: 'Next →',
  onboardingBack: '← Back',
  ...
  onboardingCategoryAdventure: 'Adventure',
  onboardingCategoryFantasy: 'Fantasy',

  installBannerTitle: 'Install Fablino?',
  installBannerSubtitle: 'Like a real app on your device',
  installBannerButton: 'OK!',
  installModalTitle: 'Fablino on your device?',
  installModalDescription: 'Install Fablino like a real app — with its own icon on your home screen!',
  installModalYes: 'Yes, install! 🦊',
  ...
  appearanceEyeColorLabel: 'Eye color',
  appearanceEyeBrown: 'Brown',
  appearanceEyeDarkBrown: 'Dark brown',
  appearanceEyeGreen: 'Green',
  appearanceEyeBlue: 'Blue',
  appearanceEyeGray: 'Gray',
  ...
  appearanceStyleBraid: 'Braid',
  appearanceStyleBob: 'Bob',
  appearanceStyleHalfUp: 'Half-up',
  appearanceStyleTwoBraids: 'Two braids',
  appearanceStyleUpdo: 'Updo',
  appearanceStyleShortAfro: 'Short afro',
  appearanceStyleAfro: 'Afro',
  appearanceStyleAfroPuffs: 'Afro puffs',
  appearanceStyleBoyShort: 'Short',
  appearanceStyleSidePart: 'Side part',
  appearanceStyleUndercut: 'Undercut',
  appearanceStyleBuzzCut: 'Buzz cut',
  appearanceStyleMediumLength: 'Medium',
  appearanceStyleSurfer: 'Surfer look',
  appearanceStyleCurlsLoose: 'Curls loose',
  ...
  myPeopleHeaderMessage: 'Design the appearance of your family and friends!',
  myPeopleEmpty: 'No people added yet!',
  myPeopleEmptyHint: 'Create a story first, then you can define the appearance of your family and friends here.',
  myPeopleAddPerson: 'Add person',
  myPeopleFamily: 'Family',
  myPeopleFriends: 'Friends',
  myPeopleAppearanceIncomplete: 'Appearance not yet filled in',
  myPeopleNoAppearance: 'No appearance defined yet',
  myPeopleUsedBy: 'Used by:',
  myPeopleEditAppearance: 'Edit appearance',
  myPeopleDefineAppearance: 'Define appearance',
  myPeopleNameLabel: 'Name',
  myPeopleNamePlaceholder: 'e.g. Mom, Grandpa Hans, Emma...',
  myPeopleRelationLabel: 'Relationship',
  myPeopleSelectPlaceholder: 'Choose...',
  myPeopleGenderLabel: 'Gender',
  myPeopleGenderMale: '♂ Male',
  myPeopleGenderFemale: '♀ Female',
  myPeopleGenderNone: '⚪ N/A',
  myPeopleForWhichKids: 'For which children?',
  myPeopleAddAndDefine: 'Add & define appearance →',
  myPeoplePersonAdded: 'Person added! ✨',
  myPeopleAddError: 'Error adding person',
  myPeopleEditorHeader: 'This is how {name} looks!',
  myPeopleSaveError: 'Error saving',
  myPeopleCreateError: 'Error creating',
  myPeopleRelationMom: 'Mom',
  myPeopleRelationDad: 'Dad',
  myPeopleRelationGrandma: 'Grandma',
  myPeopleRelationGrandpa: 'Grandpa',
  myPeopleRelationBrother: 'Brother',
  myPeopleRelationSister: 'Sister',
  myPeopleRelationAunt: 'Aunt',
  myPeopleRelationUncle: 'Uncle',
  myPeopleRelationCousinM: 'Cousin (m)',
  myPeopleRelationCousinF: 'Cousin (f)',
  myPeopleRelationFriendM: 'Friend (m)',
  myPeopleRelationFriendF: 'Friend (f)',
  myPeopleRelationOther: 'Other',
  myPeopleAgeChild: 'Child',
  myPeopleAgeTeen: 'Teen',
