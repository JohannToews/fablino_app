-- Migration: Update Pass 0 template with dynamic constraints, setup timing,
-- complexity limits, and improved self-check.
-- Also adds NO_SPECIAL_EFFECTS conditional block and fixes state-tracking example.
...

{
  ...
  "self_check": {
    "setup_payoff_map": [
      { "object": "...", "introduced_in": "P1", "payoff_in": "P6", "action": "Character uses object to..." }
    ],
    "p6_resolver": "...",
