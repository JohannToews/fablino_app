-- Migration: Pass 0 — Add Knowledge Check to self-check
--
-- Problem: Protagonists "somehow know" how to use objects or solve problems
-- without any prior scene establishing that knowledge. This creates deus ex
-- machina resolutions that feel unearned.
--
-- Fix: Add KNOWLEDGE CHECK rule and knowledge_sources field to self_check.
